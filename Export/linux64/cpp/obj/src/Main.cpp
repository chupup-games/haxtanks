...
{
		HX_STACK_FRAME("Main","create",0xacb98671,"Main.create","Main.hx",42,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(44)
...
{
		HX_STACK_FRAME("Main","update",0xb7afa57e,"Main.update","Main.hx",67,0x087e5c05)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Main","keyDownHandler",0xd5fe709e,"Main.keyDownHandler","Main.hx",76,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(76)
...
{
		HX_STACK_FRAME("Main","keyUpHandler",0x80311245,"Main.keyUpHandler","Main.hx",98,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(98)
		int _g = event->keyCode;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("Main","moveTank",0x36b6cd50,"Main.moveTank","Main.hx",116,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(118)
...
{
		HX_STACK_FRAME("Main","render",0x35d38acb,"Main.render","Main.hx",181,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(183)
