...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("Chupup Games"),HX_CSTRING("HaxTanks"),HX_CSTRING("com.chupup.haxtanks"),HX_CSTRING("1.0.0"));
				...
				HX_STACK_CATCHABLE(Dynamic, 0);
				{
					struct _Function_3_1{
						inline static bool Block( ){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",67,0x0780ded5)
							{
								HX_STACK_LINE(67)
